...
import com.zytd.account.books.bo.user.AccountUserBo;
import com.zytd.account.books.bo.user.AccountUserPageBO;
import com.zytd.account.books.common.base.ResultVO;
import com.zytd.account.books.enums.UserStatusEnum;
import com.zytd.account.books.enums.UserTypeEnum;
import com.zytd.account.books.vo.user.AccountUserPageVO;
import com.zytd.account.books.vo.user.AccountUserVO;
...
public class AccountUserController {
    ...
    @RequestMapping("/add")
    public ResultVO add(@RequestBody AccountUserBo bo){
        log.info(bo.toString());
        return ResultVO.success();
    }

    @RequestMapping("/edit")
    public ResultVO edit(@RequestBody AccountUserBo bo){
